...
<body style="background-color: #f0f9fd;text-align: center">
	...
	<hr />
	<div align="center">
	<form action="${pageContext.request.contextPath}/book/modify" method="post" enctype="multipart/form-data">
			<table>
				<td><input type="hidden" name="book.id" value="${book.id}"></td>
				<td><input type="hidden" name="book.create_date" value='<fmt:formatDate value="${book.create_date}" pattern="yyyy-MM-dd"/>'></td>
				<td><input type="hidden" name="book.sale" value="${book.sale}"></td>
				<tr>
					<td>名称：</td>
				...
				<tr>
					<td>出版时间：</td>
					<td><input type="date" name="book.press_date" class="el-input__inner" value='<fmt:formatDate value="${book.press_date}" pattern="yyyy-MM-dd"/>'></td>
					<td>内容简介：</td>
				...
				<tr>
					<td>印刷时间：</td>
					<td><input type="date" name="book.print_date" class="el-input__inner" value='<fmt:formatDate value="${book.print_date}" pattern="yyyy-MM-dd"/>'></td>
					<td>作者简介：</td>
