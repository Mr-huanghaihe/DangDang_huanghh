...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="${pageContext.request.contextPath}/user/modifyActiveCode" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<div class="mess reduce_h">
						我们给您发送了验证邮件，邮件地址为：
						<span class="red"><span id="lblEmail">${sessionScope.loginUser.email }</span>
						</span>
						<span class="t1"> 
						请登录您的邮箱收信。
					</div>
					<h4>
						第二步：输入验证码 ${sessionScope.activeCode }
					</h4>
					<div class="mess">
						<span class="write_in">输入您收到邮件中的验证码：</span>
						<input name="activeCode" type="text" id="validatecode" class="yzm_text" />
