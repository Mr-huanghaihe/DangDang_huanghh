...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="${pageContext.request.contextPath}/user/registerUser" id="f" >
				<h2>
					以下均为必填项&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					${message }
				</h2>
				<table class="tab_login" >
					...
					<tr>
						...
						<td>
							<img class="yzm_img" id='imgVcode' src="${pageContext.request.contextPath}/vdcode/validationCode" onClick="changeImage()"/>
